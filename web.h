...
<body>
    ...
    <div class="button-container">
        <button class="algorithm-button" onclick="sendCommand('change')">Algorithm 1</button>
        <button class="algorithm-button" onclick="sendCommand('remote')">Algorithm 2</button>
    </div>
    ...
    <script>
        function sendCommand(type) {
            const url = '/' + type;  // /change або /remote
